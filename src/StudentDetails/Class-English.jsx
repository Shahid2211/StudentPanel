...
import Topics1 from '../Subjects/Topic1';
import {
  Box,
  Container,
  Grid,
...
export default function Class_Chemistry() {
  ...
  const payload = { assignmentId: 0, classId: 1, sectionId: 15, studentId: 1, subjectId: 2 };
                          ...
                          <TableRow key={index}>
                            ...
                            <TableCell sx={{ fontSize: '1rem' }}>
                              <Button variant="contained" color="info" size="small" sx={{
                                ...
                                color: 'white', fontSize: '1rem' }} onClick={() => { navigation('/topics1') }}>
                                View
                              </Button>
                            </TableCell>
